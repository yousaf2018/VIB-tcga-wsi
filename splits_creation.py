...
train_len = int(60/100 * len(case_id_list))
test_len = int(20/100 * len(case_id_list))
val_len = int(20/100 * len(case_id_list))
print(train_len, val_len, test_len)
train_list = case_id_list[:train_len]
val_list = case_id_list[train_len:train_len+val_len]
test_list= case_id_list[train_len+val_len:]
